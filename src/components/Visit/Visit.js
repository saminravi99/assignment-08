        ...
        <div className="visit-container">
            <div className="mt-4 visit-card">
                ...
                <div className="d-flex flex-column align-items-center">
                    {random === -1 ? visitingCountries : getRandomCountry ? 
                ...
                <div className="d-flex flex-column align-items-center btn-div ms-5">
                    <button onClick={chooseRandom} className="btn btn-primary px-5 py-2 mb-4">Vsit A Country <i className="fa-solid fa-earth-americas ms-2 "></i> </button>
